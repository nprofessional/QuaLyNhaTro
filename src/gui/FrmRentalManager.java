...
public class FrmRentalManager extends JFrame {
	...
	public FrmRentalManager() {
		...
		gl_pnCheckin.setHorizontalGroup(gl_pnCheckin.createParallelGroup(Alignment.LEADING).addGroup(gl_pnCheckin
				...
				.addGroup(gl_pnCheckin.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pnCheckin.createSequentialGroup()
								...
								.addGap(5).addComponent(textField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_pnCheckin.createSequentialGroup()
								.addComponent(lblTnKh, GroupLayout.PREFERRED_SIZE, 105, GroupLayout.PREFERRED_SIZE)
								.addGap(5).addComponent(textField_1, GroupLayout.PREFERRED_SIZE,
						...
						.addGroup(gl_pnCheckin.createSequentialGroup()
								.addComponent(lblThiGianCheckin, GroupLayout.PREFERRED_SIZE, 105,
										GroupLayout.PREFERRED_SIZE)
								.addGap(5).addComponent(textField_2, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_pnCheckin.createSequentialGroup()
		...
		gl_pnCheckin.setVerticalGroup(gl_pnCheckin.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnCheckin.createSequentialGroup().addGap(21)
						.addGroup(gl_pnCheckin.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_pnCheckin.createSequentialGroup().addGap(3).addComponent(lblMSKhc))
								.addComponent(textField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(6)
						.addGroup(gl_pnCheckin.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_pnCheckin.createSequentialGroup().addGap(3).addComponent(lblTnKh))
								.addComponent(textField_1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(18)
						.addGroup(gl_pnCheckin.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_pnCheckin.createSequentialGroup().addGap(4).addComponent(lblLoiKhcHng))
								.addComponent(comboBox_1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(10)
						.addGroup(gl_pnCheckin.createParallelGroup(Alignment.LEADING)
								.addGroup(
										gl_pnCheckin.createSequentialGroup().addGap(3).addComponent(lblThiGianCheckin))
								.addComponent(textField_2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(10)
						.addGroup(gl_pnCheckin.createParallelGroup(Alignment.LEADING).addGroup(gl_pnCheckin
								.createSequentialGroup().addGap(3)
								.addGroup(gl_pnCheckin.createParallelGroup(Alignment.BASELINE).addComponent(lblMSPhng)
										.addComponent(textField_3, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)))
